<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignupPage.aspx.cs" Inherits="ConsumerCart.SignupPage" %>
        ...
        <div style="position: absolute; left: 500px">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="addresstxt" runat="server" CssClass="txtbox"></asp:TextBox>
                    </td>
                    <td>
                        <asp:RequiredFieldValidator ControlToValidate="addresstxt" runat="server" ErrorMessage="This is a required field" ForeColor="Red"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td colspan="3">
